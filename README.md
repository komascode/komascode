...
- 🎓 **명지대학교** 컴퓨터공학과 3학년 (재학)
- 👑 **UMC (대학생 연합 IT 동아리)** Web 파트장 & 데모데이 우수상 2회수상
- 🏫 **MAP (전공 학술 스터디)** 2026년 회장 (60명+ 규모 운영)
...
- **성과:** 초기세팅부터 보고서,개발,QA,발표 (15팀 중 2등 -> A+)
- **역할:** 풀스택 개발 (핵심 기능 구현 및 기획)
- **기술:** React Native, Expo, Spring Boot
- **내용:** 사주 로직을 활용한 사용자 매칭 알고리즘 구현, 실시간 채팅 기능 개발 중

### 🏆 UMC 데모데이 프로젝트
> **연합 동아리 웹 서비스 팀 프로젝트**
- **성과:** UMC 데모데이 우수상 (3등) 수상
- **역할:** 웹 파트 개발
- **내용:** 기획자, 디자이너와 협업하여 실제 사용 가능한 웹 서비스를 배포 및 시연
